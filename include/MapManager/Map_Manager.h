...
public:
     ...
     */
    static void
        pointAssociateToMap(PointType const* pi, PointType* po, const Eigen::Matrix4d& _transformTobeMapped);
    ...
    pcl::KdTreeFLANN<PointType> getCornerKdMap(int i) { return CornerKdMap_last[i]; }
    pcl::KdTreeFLANN<PointType> getSurfKdMap(int i) { return SurfKdMap_last[i]; }
    pcl::KdTreeFLANN<PointType> getNonFeatureKdMap(int i) { return NonFeatureKdMap_last[i]; }
    pcl::PointCloud<PointType>::Ptr get_corner_map() { return laserCloudCornerFromMap; }
    pcl::PointCloud<PointType>::Ptr get_surf_map() { return laserCloudSurfFromMap; }
    pcl::PointCloud<PointType>::Ptr get_nonfeature_map() { return laserCloudNonFeatureFromMap; }

    int get_map_current_pos() const { return currentUpdatePos; }
    int get_laserCloudCenWidth_last() const { return laserCloudCenWidth_last; }
    int get_laserCloudCenHeight_last() const { return laserCloudCenHeight_last; }
    int get_laserCloudCenDepth_last() const { return laserCloudCenDepth_last; }
...
private:
    ...
    static constexpr int laserCloudHeight = 11;
    static constexpr int laserCloudDepth  = 21;
    ...
    static constexpr int localMapWindowSize = 60;
