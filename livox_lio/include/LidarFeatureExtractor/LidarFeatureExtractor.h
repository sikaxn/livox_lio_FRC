...
public:
     ...
     */
    bool plane_judge(const std::vector<PointType>& point_list, int plane_threshold);
    ...
    void detectFeaturePoint3(pcl::PointCloud<PointType>::Ptr& cloud, std::vector<int>& pointsLessSharp);

    void FeatureExtract_with_segment(
        const livox_ros_driver2::msg::CustomMsg::ConstSharedPtr& msg,
        pcl::PointCloud<PointType>::Ptr& laserCloud, pcl::PointCloud<PointType>::Ptr& laserConerFeature,
        pcl::PointCloud<PointType>::Ptr& laserSurfFeature, pcl::PointCloud<PointType>::Ptr& laserNonFeature,
        sensor_msgs::msg::PointCloud2& msg2, int Used_Line = 1);
    ...
    void FeatureExtract(
        const livox_ros_driver2::msg::CustomMsg::ConstSharedPtr& msg,
        pcl::PointCloud<PointType>::Ptr& laserCloud, pcl::PointCloud<PointType>::Ptr& laserConerFeature,
        pcl::PointCloud<PointType>::Ptr& laserSurfFeature, int Used_Line = 1, int lidar_type = 0);

    void FeatureExtract_hap(
        const livox_ros_driver2::msg::CustomMsg::ConstSharedPtr& msg,
        pcl::PointCloud<PointType>::Ptr& laserCloud, pcl::PointCloud<PointType>::Ptr& laserConerFeature,
        pcl::PointCloud<PointType>::Ptr& laserSurfFeature, pcl::PointCloud<PointType>::Ptr& laserNonFeature,
        int Used_Line = 1);
